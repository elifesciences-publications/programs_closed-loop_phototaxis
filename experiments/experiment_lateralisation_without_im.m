...
%% Comments
% Code for the spatio-temporal experiment (lateralisation). Don't record the images
% Inputs -----
% xin, yin: coordinates of the inner circle the fish has to cross to record
...
% column: ending time of the lost sequence, 3rd column: lenght of the lost
% sequence (sec)
